...
const msgtxt1 = `<p class = "image"> <img src = "img/penguins.jpg" width=61px height=61px></p><p class="text animate__animated animate__zoomInLeft">Penguins Attack!</p>`;
const msgtxt2 = `<p class = "image"> <img src = "img/whitebear.jpg" width=61px height=61px></p><p class="text animate__animated animate__zoomInRight">bear Attack!</p>`;
